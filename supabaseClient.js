...
// --- Database: inventory entries (name, description, location, image_path) ---
// In Supabase: create table inventory_entries (
...
// );
// RLS: enable for inventory_entries with policies for user_id = auth.uid()
...
export async function getMyEntries() {
  ...
  return (data || []).map((e) => ({
    ...e,
    image_url: getImageUrl(e.image_path),
  }));
}
...
export async function getEntryById(id) {
  ...
  if (error) throw error;
  if (!data) return null;
  return { ...data, image_url: getImageUrl(data.image_path) };
}
